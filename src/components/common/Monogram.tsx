/**
 * The A × M monogram — the primary visual identity of the wedding.
 *
 * A stylised, interlocking "A" and "M" rendered as pure thin-stroke line
 * art (no font dependency, so it rasterises identically everywhere: navbar,
 * hero, footer, loading mark, and the exported favicon/social assets).
 */
